...
import 'package:segundaapp/pages/formulario.dart';
...
/////////
  Widget mostrarImagen(){
    if(imageFile!=null){
      ...
      return Text("Selecciones Imagen");
    }
  }

  void enviarImagen(){
    firebase_storage.FirebaseStorage.instance
        .ref(reffoto+'.jpg').putFile(imageFile!);
    print("Enviada");

  }

  Future <void> visualizarfoto() async{
          ...
          children:<Widget> [
            ...
            IconButton(
                onPressed: (){
                  ...
                  reffoto="tools/"+(nomfoto.replaceAll("/","").replaceAll(" ", "").replaceAll(":","_"));
                  enviarImagen();
                  visualizarfoto();
